WT_Ac_1 = read.table("ChIP_H3Ac_WT_1_promoter.bed")
WT_Ac_2 = read.table("ChIP_H3Ac_WT_2_promoter.bed")
hda6_Ac_1 = read.table("ChIP_H3Ac_hda6_1_promoter.bed")
hda6_Ac_2 = read.table("ChIP_H3Ac_hda6_2_promoter.bed")
ldl12_Ac_1 = read.table("ChIP_H3Ac_ldl12_1_promoter.bed")
ldl12_Ac_2 = read.table("ChIP_H3Ac_ldl12_2_promoter.bed")
hda6ldl12_Ac_1 = read.table("ChIP_H3Ac_hda6ldl12_1_promoter.bed")
hda6ldl12_Ac_2 = read.table("ChIP_H3Ac_hda6ldl12_2_promoter.bed")
WT_Me2_1 = read.table("ChIP_H3K4me2_WT_1_promoter.bed")
WT_Me2_2 = read.table("ChIP_H3K4me2_WT_2_promoter.bed")
hda6_Me2_1 = read.table("ChIP_H3K4me2_hda6_1_promoter.bed")
hda6_Me2_2 = read.table("ChIP_H3K4me2_hda6_2_promoter.bed")
ldl12_Me2_1 = read.table("ChIP_H3K4me2_ldl12_1_promoter.bed")
ldl12_Me2_2 = read.table("ChIP_H3K4me2_ldl12_2_promoter.bed")
hda6ldl12_Me2_1 = read.table("ChIP_H3K4me2_hda6ldl12_1_promoter.bed")
hda6ldl12_Me2_2 = read.table("ChIP_H3K4me2_hda6ldl12_2_promoter.bed")
